...
| ID | 修复内容 | 影响 | 工作量估计 |
|---|---|---|---|
| P0-5 | agent 名修回 `Prometheus` / `Sisyphus`（当前误用 `plan`/`build`） | SKILL 生成时调用错 agent，与 ADR-001/006 不一致 | 0.5 day |
...
**优先级 P2：现有 review 中其他 P1 修复**（可与 P1 并行）
...
- Worker code review（前置依赖）：[../code-review-2026-05-14.md](../code-review-2026-05-14.md)
